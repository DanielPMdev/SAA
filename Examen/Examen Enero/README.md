...
Directorio con el **examen del primer parcial** (enero 2026) y una recopilación de **exámenes de convocatorias anteriores** resueltos. El contenido cubre el pipeline completo de Machine Learning clásico: exploración, preparación de datos, reducción de dimensionalidad y aprendizaje supervisado con scikit-learn.
...
└── Examenes Años Anteriores/
    ...
    │   ├── 📓 Preparación_de_datos_Examen.ipynb
    │   └── 📄 20211215_solución.pdf
    │
    ├── Examen 2022/                                     # FIFA 20
    │   ├── 📓 FIFA_20.ipynb
    │   ├── 📄 20220209.pdf
    ...
    │   ├── 📓 Examen_Game_of_Thrones.ipynb
    │   ├── 📄 20220525.pdf
    │   └── 📊 character-predictions.csv
    │
    ├── Examen 2023/                                     # Global Shark Attacks
    │   ├── 📓 Examen20221212_Global_Shark_Attacks.ipynb
    │   └── 📄 20221212.pdf
    │
    ├── Examen 2023 - V2/                                # Airbnb Berlín
    │   ├── 📓 Examen_20230123_Precios_de_Airbnb_en_Berlin.ipynb
    │   ├── 📄 20230123.pdf
    │   └── 📊 listings_berlin.csv
    │
    ...
    └── Examen 2025/                                     # Reservas de Hotel
        ├── 📓 20250113_Reservas_de_hotel.ipynb
        ├── 📄 20250113_Reservas_de_hotel_Enunciado.docx
        └── 📊 hotel_bookings.csv
```
...
### `Posibles Preguntas Examen.docx`

Banco de preguntas teóricas de repaso para la preparación del primer parcial.

---

## 📚 Exámenes de años anteriores

| Año | Convocatoria | Dataset | Notebook | Enunciado | Datos | Técnicas principales |
|---|---|---|---|---|---|---|
| **2021** | Ordinaria | Horse Colic | `Preparación_de_datos_Examen.ipynb` | `20211215_solución.pdf` | — | Limpieza, imputación, PCA, Feature Importance |
| **2022** | Ordinaria | FIFA 20 | `FIFA_20.ipynb` | `20220209.pdf` | `players_20.csv` | Regresión Lineal, Árboles de Decisión, PCA, K-Means |
| **2022** | Recuperación | Game of Thrones | `Examen_Game_of_Thrones.ipynb` | `20220525.pdf` | `character-predictions.csv` | SVC, Decision Tree, Random Forest, Clustering, CNN (Keras) |
| **2023** | Ordinaria | Global Shark Attacks | `Examen20221212_Global_Shark_Attacks.ipynb` | `20221212.pdf` | — | Limpieza exhaustiva, PCA, Feature Importance |
| **2023** | V2 | Airbnb Berlín | `Examen_20230123_Precios_de_Airbnb_en_Berlin.ipynb` | `20230123.pdf` | `listings_berlin.csv` | Regresión Lineal, SVR, SVC, Decision Tree, PCA |
| **2024** | Ordinaria | Salaries | `Salaries.ipynb` | — | `salaries.csv` | SVM (SVR), Árboles de Decisión, OneHotEncoder |
| **2025** | Ordinaria | Hotel Bookings | `20250113_Reservas_de_hotel.ipynb` | `20250113_Reservas_de_hotel_Enunciado.docx` | `hotel_bookings.csv` | PCA, Logistic Regression, SVM, Decision Tree, Feature Importance |
...
| `scikit-learn` | PCA, SVM/SVR, Decision Tree, Logistic Regression, métricas, GridSearchCV |
...
2. Asegúrate de que los datasets correspondientes estén accesibles (ver archivos `.csv` o fuentes de datos en cada subcarpeta).
